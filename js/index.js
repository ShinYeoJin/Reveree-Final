  ...
  try {
    ...
    if (url.includes("index.html")) {
      if (!moduleCache.index) {
        moduleCache.index = await import("/js/index.js");
      }
      moduleCache.index.initIndex?.();
    } else if (url.includes("/shop_all.html")) {
      if (!moduleCache.shop) {
        moduleCache.shop = await import("/js/shop.js");
      }
      moduleCache.shop.initShop?.("ALL");
    } else if (url.includes("/shop_acc.html")) {
      if (!moduleCache.shop) {
        moduleCache.shop = await import("/js/shop.js");
      }
      moduleCache.shop.initShop?.("ACC");
    } else if (url.includes("/shop_detergent.html")) {
      if (!moduleCache.shop) {
        moduleCache.shop = await import("/js/shop.js");
      }
      moduleCache.shop.initShop?.("DETERGENT");
    } else if (url.includes("/shop_gift.html")) {
      if (!moduleCache.shop) {
        moduleCache.shop = await import("/js/shop.js");
      }
      moduleCache.shop.initShop?.("GIFT");
    } else if (url.includes("/shop_remover.html")) {
      if (!moduleCache.shop) {
        moduleCache.shop = await import("/js/shop.js");
      }
